...
const SpendingLimitsSection = () => {
  ...
  const spendingLimitsData = [
    { name: 'Lazer', value: 60, color: '#2FA179', amount: 'R$ 240,00 de R$ 400,00' },
    { name: 'Delivery', value: 84, color: '#2FA179', amount: 'R$ 254,42 de R$ 300,00' },
    { name: 'Compras', value: 12, color: '#2FA179', amount: 'R$ 61,00 de R$ 500,00' },
    { name: 'Transporte', value: 34, color: '#2FA179', amount: 'R$ 205,12 de R$ 600,00' }
  ];
      ...
      <div className="flex items-start mb-4">
        ...
        <div>
          <p className="text-lg mb-2">
            Defina <span className="text-blue-500">limites de gastos</span> por categoria. <span className="text-[#10372B] font-bold">Controle quanto quer gastar.</span>
          </p>
        </div>
      </div>
              ...
              <div className="text-sm self-center w-full text-left">
                <div className="rounded-lg bg-white text-black p-4 mb-1">
                  ...
                  <div className="space-y-4">
                    {spendingLimitsData.map((item, index) => (
                      <div key={index} className="space-y-1">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div 
                            className="bg-[#2FA179] h-2 rounded-full" 
