...
const AdditionalResources = ({ onContinue }: AdditionalResourcesProps) => {
  return (
    <div className="w-full max-w-3xl px-4 py-12 sm:py-16 flex flex-col items-center bg-white">
      ...
      <div className="grid grid-cols-2 gap-4 w-full mb-6">
        ...
        <div className="bg-sales-mint rounded-lg p-4 flex flex-col">
          ...
          <p className="text-sm">
            Participe dos nossos desafios com recompensas <span className="font-bold text-sales-green">onde você pode ganhar até R$ 1.000 / mês.</span>
          </p>
        </div>
      </div>
